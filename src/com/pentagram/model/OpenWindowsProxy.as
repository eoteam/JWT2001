package com.pentagram.model
{
	...
	public class OpenWindowsProxy extends Actor
	{
		...
		public function OpenWindowsProxy()
		{
			...
			viewsMap.put(LOGIN_WINDOW,"com.pentagram.view.components.windows.LoginWindow");
			viewsMap.put(SPREADSHEET_WINDOW,"com.pentagram.view.components.windows.ExportSpreadSheetWindow");
		}
