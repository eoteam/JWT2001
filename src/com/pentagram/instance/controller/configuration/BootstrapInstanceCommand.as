...
package com.pentagram.instance.controller.configuration
{
	 ...
	 * 
	 */
	public class BootstrapInstanceCommand extends Command
	{
		...
		{ 
			...
			commandMap.mapEvent( AppConfigStateConstants.DISPLAY_APPLICATION, StartInstanceCommand,  StateEvent, true);
